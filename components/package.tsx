...
export default function Package(){
    return <div className="w-11/12 rounded-sm shadow-sm min-h-[500px] border-2 border-gray-100 bg-gray-100 flex flex-col justify-center items-center gap-5 p-5" >
